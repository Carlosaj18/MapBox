...
<div align="center">
  ...
  <p align="center">
   Interactive MapBox with Next.js and Clusters
    <br />
    <a href="https://github.com/Carlosaj18/MapBox"><strong>Explore the site »</strong></a>
    <br />
    <br />
  </p>
</div>
...
<div align="justify">   Explore our Interactive MapBox project developed with Next.js, featuring powerful clustering capabilities. Dive into dynamic map interactions and seamless integration with Next.js, offering a highly interactive and visually engaging user experience.
...
* MapBox for interactive maps with react-map-gl
* Next.js for seamless web application development
* use-supercluster for efficient clustering functionality

## Features:

*      Interactive map functionality powered by MapBox react-map-gl
*      Seamless integration with Next.js for a smooth user experience
*      Utilization of use-supercluster for efficient clustering capabilities
*      Explore our Interactive MapBox project developed with Next.js, featuring powerful clustering capabilities. Dive into dynamic map interactions and seamless integration with Next.js, offering a highly interactive and visually engaging user experience.
...
`**Note**`: This app requires API key from <a href="https://www.mongodb.com/" >Map Box Account</a>
...
```bash
https://github.com/Carlosaj18/MapBox/
```
...
```
NEXT_PUBLIC_MAPBOX_KEY = YOUR_MONGO_API_KEY
PORT = 3000
```
...
### 7. Access the project in your browser at [`localhost:3000/`](localhost:3000)
